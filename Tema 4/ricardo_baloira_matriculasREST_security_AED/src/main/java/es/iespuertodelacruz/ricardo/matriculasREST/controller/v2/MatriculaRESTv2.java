...
@Api(value= "MatriculaRESTv2", description = "REST APIs relacionadas con la entidad Matricula accesibles para el usuario con rol ADMIN")
@RestController
@RequestMapping("/api/v2/matriculas")
public class MatriculaRESTv2 {
	private Logger logger = LoggerFactory.getLogger(MatriculaRESTv2.class);
